...
from pyhealth.models import SBSConCare
...
if __name__ == "__main__":
    ...
    base_dataset = MIMIC3Dataset(
        root="/srv/local/data/physionet.org/files/mimiciii/1.4",      # your path
    ...
    train_dataset, val_dataset, test_dataset = split_by_patient(
        sample_dataset, [0.8, 0.1, 0.1], seed=args.seed
    )
    ...
    trainer = Trainer(model=model, device="cuda:"+str(args.cuda))
    trainer.train(
