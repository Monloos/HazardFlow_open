...
class SBSConCare(BaseModel):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super(SBSConCare, self).__init__(
            dataset=dataset,
    ...
    def score_based_loss(self, patient_emb, test_mode=False, aggr='mean'):
    ...
    def forward(self, test_mode=False, **kwargs) -> Dict[str, torch.Tensor]:
        """Forward propagation.
        ...
        sm_loss, final_embed, pre_embed = self.score_based_loss(patient_emb, aggr='mean', test_mode=test_mode)
        ...
        loss = self.get_loss_function()(logits, y_true)+sm_loss+decov_loss+self.get_loss_function()(logits_old, y_old)
